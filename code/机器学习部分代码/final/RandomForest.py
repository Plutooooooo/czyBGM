...
def plot_classification_report(cr, title=None, cmap=ddlheatmap):
    ...
    plt.ylabel('Classes')
    plt.xlabel('Measures')
    plt.savefig('F:/CZY/results/all/1024/RandomForest_report.png')
    plt.show()
...
def plot_learning_curve(estimator, title, X, y,
    ...
    plt.legend(loc="best")
    plt.savefig('F:/CZY/results/all/1024/RandomForest_learning_curve.png')
    plt.show()
    return plt

if __name__ == '__main__':
    RandomForest(*load_data('F:/CZY/datasets/all/1024data.csv'))
