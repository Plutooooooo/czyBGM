...
def plot_classification_report(cr, title=None, cmap=ddlheatmap):
    ...
    plt.ylabel('Classes')
    plt.xlabel('Measures')
    plt.savefig('F:/CZY/results/necessities/1024/SVM_report.png')
    plt.show()
...
def plot_learning_curve(estimator, title, X, y,
    ...
    plt.legend(loc="best")
    plt.savefig('F:/CZY/results/necessities/1024/SVM_learning_curve.png')
    plt.show()
    return plt


if __name__ == '__main__':
    svm_c(*load_data('F:/CZY/datasets/necessities/1024data.csv'))
